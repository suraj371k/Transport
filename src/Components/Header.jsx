      ...
      <div className='absolute inset-0 bg-gradient-to-r from-black via-black/70 to-transparent'>
        <div className='w-[90vw] md:w-[70vw] lg:w-[50vw] flex justify-center flex-col h-full ml-4 md:ml-20 lg:ml-40 gap-6'>
          ...
          <div className='flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-5'>
            <Link to='/contact'>
            <button className='px-12 md:px-16 lg:px-20 font-bold py-4 md:py-5 lg:py-6 text-white bg-[#f31b1b]'>
              GET IN TOUCH
            </button>
            </Link>
            <Link to='/about'>
            <button className='border-2 border-white px-12 md:px-16 lg:px-20 font-bold py-4 md:py-5 lg:py-6 text-white'>
              ABOUT US
            </button>
            </Link>
          </div>
